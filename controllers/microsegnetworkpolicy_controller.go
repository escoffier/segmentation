...
//+kubebuilder:rbac:groups=microsegmentation.security.io,resources=microsegnetworkpolicies,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=microsegmentation.security.io,resources=microsegnetworkpolicies/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=microsegmentation.security.io,resources=microsegnetworkpolicies/finalizers,verbs=update
...
func (r *MicrosegNetworkPolicyReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&microsegmentationv1alpha1.MicrosegNetworkPolicy{}).
		Complete(r)
}
